...
export default function SpecificAsteroid() {
  ...
  return (
    <MainContainer>
      ...
      <div>
        <Link href="/asteroids">
          <div className="w-max mx-6 flex gap-1 items-center my-6 active:scale-95 transition-all">
            <MdArrowBackIos size="1rem" />
            <p className="font-semibold hover:underline">
              Back To All Asteroids
            </p>
          </div>
        </Link>
      </div>
      <div className="pb-6 px-6 rounded-md flex flex-col gap-4">
